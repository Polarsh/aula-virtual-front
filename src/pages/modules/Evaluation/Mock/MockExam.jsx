...
const generateQuestions = totalQuestions => {
  return Array.from({ length: totalQuestions }, (_, index) => ({
    index: index + 1,
    title: `Texto para pregunta ${index + 1}`,
    image:
      (index + 1) % 2 === 0
...
const mockExamJson = {
  id: 1,
  title: 'SIMULACRO ENAM 2023 - OCT 22 - CONVENIO UAC - PARTE A',
  questions: generateQuestions(totalQuestions),
  questionStats: [{}],
  questionsData: { totalQuestion: totalQuestions, answeredQuestions: 120 },
  duration: 10800,
}
...
export default function MockExamPage() {
  ...
  useEffect(() => {
    ...
    if (
      isNaN(index) ||
      index < 1 ||
      index > mockExamData.questionsData.totalQuestion
    ) {
